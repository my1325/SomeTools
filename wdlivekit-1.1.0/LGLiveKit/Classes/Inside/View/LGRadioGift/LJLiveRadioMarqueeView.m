...
@interface LJLiveRadioMarqueeView () <LJMarqueeViewTouchResponder>

@property (nonatomic, strong) UIView *contentView;
@property (nonatomic, assign) NSInteger visibleItemCount;
@property (nonatomic, strong) NSMutableArray<LJMarqueeItemView*> *items;
@property (nonatomic, assign) int firstItemIndex;
@property (nonatomic, assign) int dataIndex;
@property (nonatomic, strong) NSTimer *scrollTimer;
@property (nonatomic, strong) LJMarqueeViewTouchReceiver *touchReceiver;
...
@implementation LJLiveRadioMarqueeView
...
- (void)resetAll {
    ...
    for (int i = 0; i < _visibleItemCount + 2; i++) {
        LJMarqueeItemView *itemView = [[LJMarqueeItemView alloc] init];
...
- (void)resetTouchReceiver {
    if (_touchEnabled) {
        if (!_touchReceiver) {
            self.touchReceiver = [[LJMarqueeViewTouchReceiver alloc] init];
