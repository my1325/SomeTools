...
/// 支付方式
typedef NS_ENUM(NSUInteger, GYRechargeType) {
    GYRechargeTypeSVIP = -5,
    GYRechargeTypeIAP = 1,          // 1：苹果内购
    GYRechargeTypePP  = 2,
    GYRechargeTypeCC = 8,
...
@class GYSvipInfo, GYBannerInfo, GYUniqueTag, GYLiveConfig, GYPayConfig, GYIapConfig;

@interface GYLiveAccount : GYLiveBaseObject
...
/// svip
@property (nonatomic, strong) GYSvipInfo *svipInfo;
...
@interface GYSvipInfo : GYLiveBaseObject
...
@interface GYLiveAccountConfig : GYLiveBaseObject

@property (nonatomic, strong) NSString *uniqueTagUrl;
/// Banner信息集合
@property (nonatomic, strong) NSArray<GYBannerInfo *> *bannerInfoList;
/// 语聊房直播间Banner信息集合 *******
@property (nonatomic, strong) NSArray<GYBannerInfo *> *voiceChatRoomBannerInfoList;
/// 一对多直播配置
@property (nonatomic, strong) GYLiveConfig *liveConfig;

@property (nonatomic, strong) GYUniqueTag * __nullable defaultEventLabel;
/// 三方支付开启条件， true 开  false 没开
@property (nonatomic, assign) BOOL webPayCondition;
/// 统计充值金额是否超过10
@property (nonatomic, assign) float totalPayOver10;
/// 语聊房礼物配置 *******
//@property (nonatomic, strong) NSArray<GYLiveGift *> *voiceChatRoomGiftConfigs;
/// 支付平台方式
@property (nonatomic, strong) NSArray *rechargeTList;
/// 支付配置
@property (nonatomic, strong) NSArray<GYPayConfig *> *payConfigs;
///// 内购项
//@property (nonatomic, strong) NSArray<GYIapConfig *> *iapConfigs;
///// paypal 内购项
//@property (nonatomic, strong) NSArray<GYIapConfig *> *ppConfigs;
///// 信用卡购买项目
//@property (nonatomic, strong) NSArray<GYIapConfig *> *ccConfigs;

@end

@interface GYBannerInfo : GYLiveBaseObject
/// 图片地址
...
/// 活动弹幕标签
@interface GYUniqueTag : GYLiveBaseObject
...
@interface GYLiveConfig : GYLiveBaseObject
/// 开关
...
/// 礼物配置
@property (nonatomic, strong) NSArray<GYLiveGift *> *giftConfigs;
/// 被替换掉的礼物配置 兼容老版本
@property (nonatomic, strong) NSArray<GYLiveGift *> *videoChatRoomReplacedGiftConfigs;
/// pk进度条
...
@interface GYPayConfig : NSObject

/// 类型
@property (nonatomic, assign) GYRechargeType type;
/// 标题
@property (nonatomic, strong) NSString *title;
/// 图片
...
/// 购买项
@property (nonatomic, strong) NSArray<GYIapConfig *> *products;

@end


#pragma mark - IapConfig
@interface GYIapConfig : NSObject
