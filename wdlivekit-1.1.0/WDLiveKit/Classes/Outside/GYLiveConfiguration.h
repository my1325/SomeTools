...
typedef NS_ENUM(NSUInteger, GYLiveChannel) {
    GYLiveChannelDefault = 0,
    GYLiveChannelDama = 151,
};

@interface GYLiveConfiguration : NSObject
...
@property (nonatomic, assign) GYLiveChannel channel;
