...
typedef NS_ENUM(NSInteger, GYLiveAutoScrollDirection) {
    GYLiveAutoScrollDirectionRight,
    GYLiveAutoScrollDirectionLeft
};

@interface GYLiveAutoScrollLabel : UIView <UIScrollViewDelegate>

@property (nonatomic) GYLiveAutoScrollDirection scrollDirection;
