//
//  GYLiveAutoScrollLabel.m
//  GYLiveAutoScrollLabel
//
...
@interface GYLiveAutoScrollLabel ()
...
@implementation GYLiveAutoScrollLabel
...
- (void)commonInit {
    ...
    // default values
    _scrollDirection = GYLiveAutoScrollDirectionLeft;
...
- (void)setScrollDirection:(GYLiveAutoScrollDirection)direction {
...
- (void)scrollLabelIfNeeded {
    ...
    BOOL doScrollLeft = (self.scrollDirection == GYLiveAutoScrollDirectionLeft);
...
- (void)applyGradientMaskForFadeLength:(CGFloat)fadeLength enableFade:(BOOL)fade {
    ...
    if (fadeLength) {
        ...
        if (!fade) switch (self.scrollDirection) {
                case GYLiveAutoScrollDirectionLeft:
                    leftFadePoint = @0;
                    break;

                case GYLiveAutoScrollDirectionRight:
                    leftFadePoint = @0;
                    rightFadePoint = @1;
                    break;
            }
