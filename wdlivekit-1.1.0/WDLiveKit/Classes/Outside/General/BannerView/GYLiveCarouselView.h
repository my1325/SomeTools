 ...
 *  代理
 */
@protocol GYLiveCarouselViewDelegate <NSObject>
 ...
 *  @param index        图片索引
 */
- (void)carouselView:(GYLiveCarouselView *)carouselView clickImageAtIndex:(NSInteger)index;
 ...
 *  其他属性都有默认值，可不设置
 */
@interface GYLiveCarouselView : UIView
 ...
 *  代理，用来处理图片的点击
 */
@property (nonatomic, weak) id<GYLiveCarouselViewDelegate> delegate;
