...
@interface GYLiveImagePicker () <UIImagePickerControllerDelegate, UINavigationControllerDelegate>

@property (nonatomic, copy) GYLiveImageBlock imagesBlock;

@end

@implementation GYLiveImagePicker
...
+ (void)tyb_photoLibraryWithSender:(UIViewController *)vc
                        ...
                        completion:(GYLiveImageBlock)completion
{
    [GYLiveAuth fb_requestPhotoAlbumAuthSuccess:^{
        GYLiveImagePicker *selector = [[GYLiveImagePicker alloc] init];
